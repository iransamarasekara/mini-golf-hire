      ...
      >
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
          ...
          <nav
            ...
            } fixed top-[7rem] bottom-[2rem] left-[5%] right-[5%] rounded-lg bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}
          >
          ...
          <RoundButton className="hidden lg:flex" href="/booknow">
            Book Now
          </RoundButton>
